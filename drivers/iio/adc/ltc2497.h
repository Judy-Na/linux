 ...
 * covers the LTC2496/LTC2497, which have no speed mode.
 *
 ...
 * SPD control actually faster.  When FA/FB rejection selection is added later,
 * the per-mode timing simply grows a rejection axis - see
 * ltc2497core_conv_time_ms().
 */
